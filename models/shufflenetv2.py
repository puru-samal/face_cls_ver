...
class ShuffleNetV2(nn.Module):
    def __init__(self, net_size, embedding_size=512, num_classes=1000, dropout_rate=0.0):
        ...
        self.embedding = nn.Sequential(OrderedDict([
            ...
            ('linear', nn.Linear(out_channels[3], embedding_size, bias=False)),
...
def get_shufflenet(model_type='shufflenetv2_0.5', embedding_size=512, num_classes=1000, dropout_rate=0.0):
    """Factory function for ShuffleNetV2."""
...
if __name__ == "__main__":
    # Example usage:
    model = get_shufflenet(model_type='shufflenetv2_0.5', embedding_size=512, num_classes=1000, dropout_rate=0.0)
